...
-- =============================================================================
-- NARAKU BLOX CORE ENGINE (100% PERFECT CLEAN - SYNCHRONIZED RE-FIXED)
-- =============================================================================
...
-- 2. Inisialisasi Referensi Objek (MURNI SINKRON 100% DENGAN FILE updatenewui.txt)
...
-- Konten Sub-Panel Samping (FIXED INDEX - SINKRON STRUKTUR ASLI)
local PanelMain     = LMG2L["PanelMain_64"]      -- PAKE INDEX 64 YANG ASLI (Bukan 65/6a)
local PanelMenu     = LMG2L["PanelConsole_4c"]   -- PAKE INDEX PanelConsole_4c YANG ASLI (Bukan PanelMenu)
...
-- Tombol Trigger Navigasi Tambahan (FIXED INDEX - SINKRON STRUKTUR ASLI)
local UploadButton  = LMG2L["UploadButton_81"]    -- PAKE INDEX 81 YANG ASLI (Bukan 7c/78)
...
local function gantiTabPanel(tombolTarget, panelTarget)
    -- Matikan SEMUA panel anak agar tidak saling bertubrukan/numpuk di layar
...
-- =============================================================================
-- LOGIKA CLOSE, OPEN, DRAGGING, DAN ANIMASI GRADIENT (AMAN & STABIL)
-- =============================================================================
...
print("NARAKU BLOX MAIN ENGINE SINKRON 100% FIXED!")
-- =============================================================================
